...
def process_tsne(data, tool):
    ...
    for chr_n in chrm_list:
        chrm = "chr" + str(chr_n)
        file = "output/" + data + "/50kb_resolution_intrachromosomal/" + tool + "-output-128/" + chrm + ".emb"
        ...
        tSNE_output = "output/" + data + "/50kb_resolution_intrachromosomal/" + tool + "-output-128/tSNE/" + chrm + "-tSNE.txt"
...
def plot_graph(data):
    ...
    for chr_n in chrm_list:
        ...
        tSNE_output_1 = "output/" + data + "/50kb_resolution_intrachromosomal/deepwalk-output-128/tSNE/" + chrm + "-tSNE.txt"
        tSNE_output_2 = "output/" + data + "/50kb_resolution_intrachromosomal/line-output-128/tSNE/" + chrm + "-tSNE.txt"
        tSNE_output_3 = "output/" + data + "/50kb_resolution_intrachromosomal/node2vec-output-128/tSNE/" + chrm + "-tSNE.txt"
