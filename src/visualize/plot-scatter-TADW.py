...
def main():
    ...
    for chr_n in chrm_list:
        ...
        tSNE_output = "output/50kb_resolution_intrachromosomal/TADW-output-2/" + chrm + ".csv"
        ...
        with open(tSNE_output) as f:
            ...
            for line in f:
                ...
                col.append(label_map[bin_list[int(float(splitLine[0]))]])
        ...
        plt.savefig("output/graphs-50kb/TADW-2/" + chrm + "-dim2.png")
